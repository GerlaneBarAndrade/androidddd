...
import ifpb.edu.br.convite.adapter.PessoasCustomAdapter;
import ifpb.edu.br.convite.asyntask.BuscarNomeAsyncTask;
import ifpb.edu.br.convite.callback.BuscarPessoaCallBack;
...
public class BuscarNomeActivity extends Activity implements TextWatcher, OnItemClickListener, BuscarPessoaCallBack {
    ...
    private static int TAMANHO_MINIMO_TEXTO = 6;
